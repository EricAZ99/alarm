...
function dark_mode() {
    ...
    let alarmBorder = document.getElementById("alarmBorder");
    ...
    if (main_container.classList.contains("bg-[#f2f7ff]")) {
        ...
        alarmBorder.classList.remove("border-red-500");
        alarmBorder.classList.add("border-blue-500");
    } else {
        ...
        alarmBorder.classList.remove("border-blue-500");
        alarmBorder.classList.add("border-red-500");
    }
}
</script>
<template>
    <div id="main_container"
        ...
        <div class="h-full w-full flex justify-center">
            ...
            <div v-if="homeClose" class="min-w-[20rem] w-[40%] flex flex-col justify-center items-center">
                <div>
                    {{ nowDate }}
                </div>
